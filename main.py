...
chat_completion = client.chat.completions.create(
    messages=[
        ...
        {
            "role": "user",
            "content": f"Provide a brief summary of the book '{book_title}' by {book_author}. Give some information about the author. Provide relevant reference website links in markdown formatting for more information. Do not provide a thank you note or anything indicating this was generated by an LLM.",
        }
    ],
